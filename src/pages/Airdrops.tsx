...
export default function Airdrops() {
    ...
    const loadPosts = async () => {
        try {
            const data = await getPostsByType('airdrop')
            setPosts(data)
        } catch (error) {
            ...
            <div className="container mx-auto px-4 max-w-7xl">
                ...
                <div className="text-center mb-12">
                    ...
                    <p className="text-xl text-gray-400 max-w-2xl mx-auto">
                        Найактуальніші роздачі токенів та можливості для заробітку без вкладень
                    </p>
                </div>
                ...
                {filteredPosts.length === 0 ? (
                    <div className="text-center py-16">
                        ...
                        <h3 className="text-xl font-semibold mb-2">Аірдропів поки немає</h3>
                        <p className="text-gray-400">Слідкуйте за оновленнями, AI агент вже шукає нові можливості!</p>
                    </div>
                ) : (
                            ...
                            >
                                ...
                                {post.featuredImage && (
                                    <div className="aspect-video overflow-hidden rounded-t-lg relative">
                                        ...
                                        />
                                        <div className="absolute top-2 right-2 px-2 py-1 bg-primary text-white text-xs font-bold rounded">
                                            AIRDROP
                                        </div>
                                    </div>
                                )}
