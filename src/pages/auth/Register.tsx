...
import { TrendingUp, Mail, Lock, User, Eye, EyeOff, AlertCircle, Loader2 } from 'lucide-react'
...
export default function Register() {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            const { user, error: authError } = await registerWithEmail(
                formData.email,
                formData.password,
                formData.firstName,
                formData.lastName,
            ...
            <div className="relative w-full max-w-md">
                ...
                <Card glass>
                    <CardHeader className="text-center">
                        ...
                        <CardDescription>Заповніть форму щоб почати працювати</CardDescription>
                    </CardHeader>
                    ...
                    <CardContent>
                        ...
                        <form onSubmit={handleSubmit} className="space-y-4">
                            ...
                            <div className="grid grid-cols-2 gap-4">
                                ...
                                <div>
                                    <label className="text-sm font-medium mb-2 block">Прізвище</label>
                                    <div className="relative">
                                        <User className="absolute left-3 top-1/2 -translate-y-1/2 w-5 h-5 text-foreground-muted" />
                                        <input
                                            type="text"
                            ...
                            <div>
                                ...
                                <p className="text-xs text-foreground-muted mt-1">Мінімум 6 символів</p>
                            </div>

                            {/* Confirm Password */}
                            <div>
                                <label className="text-sm font-medium mb-2 block">Підтвердити пароль</label>
                                <div className="relative">
                                    <Lock className="absolute left-3 top-1/2 -translate-y-1/2 w-5 h-5 text-foreground-muted" />
                                    <input
                                        type={showPassword ? 'text' : 'password'}
                ...
                <p className="text-center text-xs text-foreground-subtle mt-6">
                    ...
                    <a href="#" className="text-primary hover:underline">Умовами використання</a>
                    {' '}та{' '}
                    <a href="#" className="text-primary hover:underline">Політикою конфіденційності</a>
                </p>
            </div>
        </div>
    )
