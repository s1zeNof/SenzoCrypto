        ...
        <div className="min-h-screen flex items-center justify-center bg-background p-4">
            <div className="w-full max-w-md">
                <div className="text-center mb-8">
                    ...
                    <p className="text-gray-400">Вхід в панель управління</p>
                </div>
                ...
                <div className="bg-surface border border-border rounded-lg p-8">
                    ...
                    <div className="relative my-6">
                        ...
                        <div className="relative flex justify-center text-sm">
                            <span className="px-2 bg-surface text-gray-400">або</span>
                        </div>
                    </div>
                    ...
                    <button
                        ...
                        disabled={loading}
                        className="w-full flex items-center justify-center gap-2 px-4 py-3 bg-background border border-border text-white rounded-lg hover:bg-surface transition-colors disabled:opacity-50"
                    >
                ...
                <p className="text-center text-xs text-gray-500 mt-6">
                    Використовуйте той самий акаунт що і на основному сайті
                </p>
            </div>
        </div>
    )
